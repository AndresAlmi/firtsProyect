...
$id = $_GET["id_taller"];
$listadoDomicilioTaller = domicilioTaller::obtenerPorIdTallerIdDomicilio($id, $idDomicilio);
?>
<!DOCTYPE html>
<html lang = "es">
<head>
...
<body>
    ...
    <section class="contenedorFormularios">
        ...
        <form action="procesar_nuevo.php" method="POST" class="formulario" id="formularioDomicilio">
            ...
            <input type = "hidden" name = "txtIdDomicilioTaller" value = "<?php echo $listadoDomicilioTaller->getIdDomicilioTaller();?>">
            ...
            <div class="formulario_grupo" id="grupo_Calle">
                ...
                <div class="formulario_grupo-input">
                    <input type = "text" name = "txtCalle" class = "formulario_input" value = "<?php echo $listadoDomicilioTaller->getCalle(); ?>">
                </div>
            </div>
            ...
            <div class="formulario_grupo" id="grupo_Altura">
                ...
                <div class="formulario_grupo-input">
                    <input type = "number" name = "txtAltura" class = "formulario_input"  value = "<?php echo $listadoDomicilioTaller->getAltura(); ?>">
                </div>
            </div>
            ...
            <div class="formulario_grupo" id="grupo_Manzana">
                ...
                <div class="formulario_grupo-input">
                    <input type = "text" name = "txtManzana" class = "formulario_input" value = "<?php echo $listadoDomicilioTaller->getManzana(); ?>">
                </div>
            </div>
            ...
            <div class="formulario_grupo" id="grupo_Torre">
                ...
                <div class="formulario_grupo-input">
                    <input type = "text" name = "txtTorre" class = "formulario_input" value = "<?php echo $listadoDomicilioTaller->getTorre(); ?>">
                </div>
            </div>
                ...
                <div class="formulario_grupo-input">
                    <input type = "number" name = "txtPiso" class = "formulario_input" value = "<?php echo $listadoDomicilioTaller->getPiso(); ?>">
                </div>
            </div>
            ...
            <div class="formulario_grupo" id="grupo_Casa">
                ...
                <div class="formulario_grupo-input">
                    <input type = "number" name = "txtCasa" class = "formulario_input" value = "<?php echo $listadoDomicilioTaller->getNumCasa(); ?>">
                </div>
            </div>
