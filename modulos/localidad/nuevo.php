...
<body>
	...
	<section class="contenedorFormularios">
		...
		<form action="procesar_nuevo.php" method="POST" class="formulario" id="formularioLocalidad">
            
            <div class="formulario_grupo" id="grupo_Pais">
                <label for = "provincia" class = "formulario_label"> Pais: </label>
                <div class="formulario_grupo-input">
                    <select onchange = "cargarProvincias();" name="cboPais" id="cboPais" class="formulario_input" style="width: 100%; height: 100%">
            ...
            <div class="formulario_grupo" id="grupo_Provincia">
                ...
                <div class="formulario_grupo-input">
                    <select name="cboProvincia" id="cboProvincia" class="formulario_input" style="width: 100%; height: 100%">
                        <option value="">Seleccionar</option>
                    </select>
                </div>
            </div>
            ...
            <div class="formulario_grupo" id="grupo_descripcion">
                ...
                <div class="formulario_grupo-input">
                    <input class = "formulario_input" type="text" name="txtDescripcion" id="txtDescripcion" placeholder= "Ej. Fontana" >
